...
class ManufacturerListViewTest(BaseTestCase):
    ...
    def test_search_functionality(self):
        response = self.client.get(reverse('taxi:manufacturer-list'), {'name': 'Subaru'})
...
class DriverListViewTest(BaseTestCase):
    ...
    def test_search_functionality(self):
        response = self.client.get(reverse('taxi:driver-list'), {'username': 'reichikku'})
...
class CarListViewTest(BaseTestCase):
    ...
    def test_search_functionality(self):
        response = self.client.get(reverse('taxi:car-list'), {'model': 'Subaru Forester'})
